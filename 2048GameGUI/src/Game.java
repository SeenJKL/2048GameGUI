...
public class Game {
    ...
    public void render()
    {
        ...
        for(int i = 0; i < Main1.pixels.length; i++)
        {
            Main1.pixels[i] = Renderer.pixels[i];
        }
    }
    public void renderText(Graphics2D g)
    {
        ...
        for(int i = 0; i < objects.size(); i++)
        {
            ...
            String s = o.value + "";
            int sw = (int) (g.getFontMetrics().stringWidth(s) / 2 / Main1.scale);
            g.drawString(s, (int) (o.x + o.width / 2 - sw) * Main1.scale, (int) (o.y + o.height / 2 + 18) * Main1.scale);
        }
    }
}
